...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fswiss-cybersecurity-mcp.svg)](https://www.npmjs.com/package/@ansvar/swiss-cybersecurity-mcp)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![CI](https://github.com/Ansvar-Systems/swiss-cybersecurity-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/swiss-cybersecurity-mcp/actions/workflows/ci.yml)
...
**Endpoint:** `https://mcp.ansvar.eu/swiss-cybersecurity/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add swiss-cybersecurity-mcp --transport http https://mcp.ansvar.eu/swiss-cybersecurity/mcp` |
...
```json
{
  "mcpServers": {
    "swiss-cybersecurity-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/swiss-cybersecurity/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/swiss-cybersecurity-mcp
```
...
```json
{
  "mcpServers": {
    "swiss-cybersecurity-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/swiss-cybersecurity-mcp"]
    }
  }
}
```
...
| Tool | Description |
|------|-------------|
| `ch_cyber_search_guidance` | Full-text search across NCSC-CH guidelines and technical reports. Covers Swiss ISB (Information Security in the Feder... |
| `ch_cyber_get_guidance` | Get a specific NCSC-CH guidance document by reference (e.g., |
| `ch_cyber_search_advisories` | Search NCSC-CH security advisories and warnings. Returns advisories with severity, affected products, and CVE referen... |
| `ch_cyber_get_advisory` | Get a specific NCSC-CH security advisory by reference (e.g., |
| `ch_cyber_list_frameworks` | List all NCSC-CH frameworks and standard series covered in this MCP, including ISB standards, ISG (Informationssicher... |
| `ch_cyber_about` | Return metadata about this MCP server: version, data source, coverage, and tool list. |
